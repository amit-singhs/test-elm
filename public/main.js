...
var $author$project$CallExternalAPI$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$CallExternalAPI$Failure = {$: 'Failure'};
var $author$project$CallExternalAPI$Success = function (a) {
	return {$: 'Success', a: a};
};
