...
>>>>>>> 77f8066... % button operation implemented.
		} else {
			return dict;
		}
<<<<<<< HEAD
...
var $author$project$MacCalciUI$renderFloatToNumberType = function (floatNumber) {
	if (!A2(
...
var $author$project$MacCalciUI$renderNumberTypetoFloat = function (numType) {
	if (numType.$ === 'Integer') {
		var i = numType.a;
		return i;
	} else {
...
=======
			...
			case 'DivideByHundred':
				return _Utils_update(
					model,
					{
						displayedNumber: function () {
							var _v3 = model.displayedNumber;
							if (_v3.$ === 'Integer') {
								var x = _v3.a;
								return $author$project$MacCalciUI$renderFloatToNumberType(x / 100);
							} else {
								var x = _v3.a;
								var y = _v3.b;
								return $author$project$MacCalciUI$renderFloatToNumberType(
									$author$project$MacCalciUI$renderNumberTypetoFloat(
										A2($author$project$MacCalciUI$Decimal, x, y)) / 100);
							}
						}()
					});
			case 'EqualsTo':
				var calculateResult = function (m) {
					var _v4 = m.operationType;
					if (_v4.$ === 'Just') {
						switch (_v4.a.$) {
							case 'Addition':
								var _v5 = _v4.a;
								var _v6 = m.firstNumber;
								if (_v6.$ === 'Integer') {
									var a = _v6.a;
									...
									if (_v7.$ === 'Integer') {
										...
										var d = _v7.b;
										return $author$project$MacCalciUI$renderFloatToNumberType(
											a + $author$project$MacCalciUI$renderNumberTypetoFloat(
												A2($author$project$MacCalciUI$Decimal, c, d)));
									}
								} else {
									var e = _v6.a;
									var f = _v6.b;
									var _v8 = m.secondNumber;
									if (_v8.$ === 'Integer') {
										var g = _v8.a;
										return $author$project$MacCalciUI$renderFloatToNumberType(
											$author$project$MacCalciUI$renderNumberTypetoFloat(
										...
										return $author$project$MacCalciUI$renderFloatToNumberType(
											$author$project$MacCalciUI$renderNumberTypetoFloat(
												A2($author$project$MacCalciUI$Decimal, e, f)) + $author$project$MacCalciUI$renderNumberTypetoFloat(
												A2($author$project$MacCalciUI$Decimal, h, i)));
									}
								}
							case 'Subtraction':
								var _v9 = _v4.a;
								var _v10 = m.firstNumber;
								if (_v10.$ === 'Integer') {
									var a = _v10.a;
...
var $author$project$MacCalciUI$DivideByHundred = {$: 'DivideByHundred'};
...
>>>>>>> 77f8066... % button operation implemented.
				...
				return function (buttonEvent) {
					return function (tL) {
						return function (tR) {
							return function (bL) {
								return function (bR) {
									return function (backGroundRed) {
										return function (backGroundGreen) {
											return function (backGroundBlue) {
												return function (onPressRed) {
													return function (onPressBlue) {
														return function (onPressGreen) {
															return A2(
																...
																_List_fromArray(
																	[
																		...
																		$mdgriffith$elm_ui$Element$Background$color(
																			A3($mdgriffith$elm_ui$Element$rgb255, backGroundRed, backGroundGreen, backGroundBlue)),
																		...
																		$mdgriffith$elm_ui$Element$mouseDown(
																			_List_fromArray(
																				[
																					$mdgriffith$elm_ui$Element$Background$color(
																						A3($mdgriffith$elm_ui$Element$rgb255, onPressRed, onPressBlue, onPressGreen)),
																					$mdgriffith$elm_ui$Element$Border$color(
																						A3($mdgriffith$elm_ui$Element$rgb255, 84, 83, 81))
																				]))
																	]),
										...
										_List_fromArray(
											[
												A2(
													...
													_List_fromArray(
														[
															createButton('AC')(70)($author$project$MacCalciUI$AllClearTextField)(0)(0)(0)(0)(103)(102)(101)(126)(126)(125)
														])),
												A2(
													$mdgriffith$elm_ui$Element$column,
													_List_Nil,
													_List_fromArray(
														[
															createButton('+/-')(70)(
																$author$project$MacCalciUI$DoNothing(''))(0)(0)(0)(0)(103)(102)(101)(126)(126)(125)
														])),
												A2(
													$mdgriffith$elm_ui$Element$column,
													_List_Nil,
													_List_fromArray(
														[
															createButton('%')(70)($author$project$MacCalciUI$DivideByHundred)(0)(0)(0)(0)(103)(102)(101)(126)(126)(125)
														])),
												A2(
													$mdgriffith$elm_ui$Element$column,
													_List_Nil,
													_List_fromArray(
														[
															createButton('÷')(80)($author$project$MacCalciUI$DivideNumbers)(0)(0)(0)(0)(253)(160)(39)(192)(129)(46)
														]))
											])),
									A2(
										$mdgriffith$elm_ui$Element$row,
											...
											[
												A2(
													...
													_List_fromArray(
														[
															createButton('7')(70)(
																$author$project$MacCalciUI$InsertDigit(7))(0)(0)(0)(0)(126)(126)(125)(180)(180)(179)
														])),
												A2(
													$mdgriffith$elm_ui$Element$column,
													_List_Nil,
													_List_fromArray(
														[
															createButton('8')(70)(
																$author$project$MacCalciUI$InsertDigit(8))(0)(0)(0)(0)(126)(126)(125)(180)(180)(179)
														])),
												A2(
													$mdgriffith$elm_ui$Element$column,
													_List_Nil,
													_List_fromArray(
														[
															createButton('9')(70)(
																$author$project$MacCalciUI$InsertDigit(9))(0)(0)(0)(0)(126)(126)(125)(180)(180)(179)
														])),
												A2(
													$mdgriffith$elm_ui$Element$column,
													_List_Nil,
													_List_fromArray(
														[
															createButton('X')(80)($author$project$MacCalciUI$MultiplyNumbers)(0)(0)(0)(0)(253)(160)(39)(192)(129)(46)
														]))
											])),
									A2(
										$mdgriffith$elm_ui$Element$row,
											...
											[
												A2(
													...
													_List_fromArray(
														[
															createButton('4')(70)(
																$author$project$MacCalciUI$InsertDigit(4))(0)(0)(0)(0)(126)(126)(125)(180)(180)(179)
														])),
												A2(
													$mdgriffith$elm_ui$Element$column,
													_List_Nil,
													_List_fromArray(
														[
															createButton('5')(70)(
																$author$project$MacCalciUI$InsertDigit(5))(0)(0)(0)(0)(126)(126)(125)(180)(180)(179)
														])),
												A2(
													$mdgriffith$elm_ui$Element$column,
													_List_Nil,
													_List_fromArray(
														[
															createButton('6')(70)(
																$author$project$MacCalciUI$InsertDigit(6))(0)(0)(0)(0)(126)(126)(125)(180)(180)(179)
														])),
												A2(
													$mdgriffith$elm_ui$Element$column,
													_List_Nil,
													_List_fromArray(
														[
															createButton('—')(80)($author$project$MacCalciUI$SubtractNumbers)(0)(0)(0)(0)(253)(160)(39)(192)(129)(46)
														]))
											])),
									A2(
										$mdgriffith$elm_ui$Element$row,
											...
											[
												A2(
													...
													_List_fromArray(
														[
															createButton('1')(70)(
																$author$project$MacCalciUI$InsertDigit(1))(0)(0)(0)(0)(126)(126)(125)(180)(180)(179)
														])),
												A2(
													$mdgriffith$elm_ui$Element$column,
													_List_Nil,
													_List_fromArray(
														[
															createButton('2')(70)(
																$author$project$MacCalciUI$InsertDigit(2))(0)(0)(0)(0)(126)(126)(125)(180)(180)(179)
														])),
												A2(
													$mdgriffith$elm_ui$Element$column,
													_List_Nil,
													_List_fromArray(
														[
															createButton('3')(70)(
																$author$project$MacCalciUI$InsertDigit(3))(0)(0)(0)(0)(126)(126)(125)(180)(180)(179)
														])),
												A2(
													$mdgriffith$elm_ui$Element$column,
													_List_Nil,
													_List_fromArray(
														[
															createButton('+')(80)($author$project$MacCalciUI$AddNumbers)(0)(0)(0)(0)(253)(160)(39)(192)(129)(46)
														]))
											])),
									A2(
										$mdgriffith$elm_ui$Element$row,
											...
											[
												A2(
													...
													_List_fromArray(
														[
															createButton('0')(140)(
																$author$project$MacCalciUI$InsertDigit(0))(0)(0)(12)(0)(126)(126)(125)(180)(180)(179)
														])),
												A2(
													$mdgriffith$elm_ui$Element$column,
													_List_Nil,
													_List_fromArray(
														[
															createButton('.')(70)($author$project$MacCalciUI$DecimalButtonPressed)(0)(0)(0)(0)(126)(126)(125)(180)(180)(179)
														])),
												A2(
													$mdgriffith$elm_ui$Element$column,
													_List_Nil,
													_List_fromArray(
														[
															createButton('=')(80)($author$project$MacCalciUI$EqualsTo)(0)(0)(0)(12)(253)(160)(39)(192)(129)(46)
														]))
											]))
								]))
					])));
	...
	_Platform_export({
		'MacCalciUI': {
			'init': $author$project$MacCalciUI$main(
				$elm$json$Json$Decode$succeed(_Utils_Tuple0))({ "versions": { "elm": "0.19.1" }, "types": { "message": "MacCalciUI.Msg", "aliases": {}, "unions": { "MacCalciUI.Msg": { "args": [], "tags": { "AddNumbers": [], "SubtractNumbers": [], "MultiplyNumbers": [], "DivideNumbers": [], "DivideByHundred": [], "InsertDigit": ["Basics.Int"], "AllClearTextField": [], "EqualsTo": [], "DecimalButtonPressed": [], "DoNothing": ["String.String"] } }, "Basics.Int": { "args": [], "tags": { "Int": [] } }, "String.String": { "args": [], "tags": { "String": [] } } } } })
		}
	});
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											createButton('%')(70)($author$project$MacCalciUI$DivideByHundred)(0)(0)(0)(0)(103)(102)(101)
										])),
									A2(
									$mdgriffith$elm_ui$Element$column,
									_List_Nil,
