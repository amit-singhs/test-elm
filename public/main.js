...
var $author$project$RashanList$init = {idCounter: 1, newItem: '', shoppingList: _List_Nil};
...
var $author$project$RashanList$Item = F3(
	function (label, isPurchased, id) {
		return {id: id, isPurchased: isPurchased, label: label};
	});
...
var $author$project$RashanList$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Additem':
				var _v1 = $elm$core$String$trim(model.newItem);
				if (_v1 === '') {
					return _Utils_update(
						model,
						{newItem: ''});
					...
					return _Utils_update(
						model,
						{
							...
							shoppingList: A2(
								$elm$core$List$cons,
								A3($author$project$RashanList$Item, s, true, model.idCounter),
								model.shoppingList)
						});
				}
			case 'UpdateNewItem':
					...
					model,
					{
						shoppingList: A2(
							...
							A2(
								...
								function (it) {
									return !_Utils_eq(item.id, it.id);
								},
								model.shoppingList))
					});
			default:
...
var $author$project$RashanList$Additem = {$: 'Additem'};
var $author$project$RashanList$UpdateNewItem = function (a) {
	return {$: 'UpdateNewItem', a: a};
};
...
var $author$project$RashanList$ItemPurchased = function (a) {
	return {$: 'ItemPurchased', a: a};
};
var $author$project$RashanList$ItemUnPurchased = function (a) {
	return {$: 'ItemUnPurchased', a: a};
};
...
var $author$project$RashanList$renderToList = function (xs) {
	if (!xs.b) {
		return _List_fromArray(
			[
				A2(
		...
		return item.isPurchased ? A2(
			...
			A2(
				...
				_List_fromArray(
					[
						...
						A3($mdgriffith$elm_ui$Element$rgb255, 30, 170, 160)),
						$mdgriffith$elm_ui$Element$Font$heavy,
						$mdgriffith$elm_ui$Element$Events$onClick(
						$author$project$RashanList$ItemPurchased(item))
					]),
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text(
						$elm$core$String$fromInt(item.id) + ('.) ' + item.label))
					])),
			$author$project$RashanList$renderToList(tail)) : A2(
			$elm$core$List$cons,
			A2(
				$mdgriffith$elm_ui$Element$row,
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$padding(6),
						$mdgriffith$elm_ui$Element$Font$color(
						A3($mdgriffith$elm_ui$Element$rgb255, 56, 125, 138)),
						$mdgriffith$elm_ui$Element$Font$heavy,
						$mdgriffith$elm_ui$Element$Font$strike,
						$mdgriffith$elm_ui$Element$Events$onClick(
						$author$project$RashanList$ItemUnPurchased(item))
					]),
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text(
			...
			$author$project$RashanList$renderToList(tail));
	}
};
...
var $author$project$RashanList$view = function (model) {
	var backgroundImagePath = 'https://i.ytimg.com/vi/GlNbzAGZC2M/maxresdefault.jpg';
	var behindContentBlock = $mdgriffith$elm_ui$Element$behindContent(
		A2(
			...
			{description: 'A grocery shop image', src: backgroundImagePath}));
	return A2(
			...
			[
				$mdgriffith$elm_ui$Element$Background$gradient(
				{
					...
					steps: _List_fromArray(
						[
							A3($mdgriffith$elm_ui$Element$rgb255, 251, 171, 126),
							A3($mdgriffith$elm_ui$Element$rgb255, 247, 206, 104)
						])
				}),
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
		...
		A2(
			...
			_List_fromArray(
				[
						...
						[
								...
								[
									...
									_List_fromArray(
										[
											...
											{name: 'Libre Franklin', url: 'https://fonts.googleapis.com/css2?family=Libre+Franklin:wght@800&display=swap'}),
											$mdgriffith$elm_ui$Element$Font$sansSerif
										]))
								]),
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$text('Rashan List')
								])),
							A2(
							$mdgriffith$elm_ui$Element$row,
							_List_Nil,
							_List_fromArray(
								[
									...
									{
										label: $mdgriffith$elm_ui$Element$Input$labelHidden('Add new item'),
										onChange: $author$project$RashanList$UpdateNewItem,
										placeholder: $elm$core$Maybe$Just(
											A2(
												$mdgriffith$elm_ui$Element$Input$placeholder,
												_List_Nil,
												$mdgriffith$elm_ui$Element$text('Add new item'))),
										text: model.newItem
									}),
									A2(
									$mdgriffith$elm_ui$Element$row,
										...
										[
											...
											_List_fromArray(
												[
													...
													$mdgriffith$elm_ui$Element$Border$color(
													A3($mdgriffith$elm_ui$Element$rgb255, 110, 150, 150)),
													$mdgriffith$elm_ui$Element$Background$color(
													A3($mdgriffith$elm_ui$Element$rgb255, 180, 200, 200)),
													$mdgriffith$elm_ui$Element$Font$variant($mdgriffith$elm_ui$Element$Font$smallCaps),
													$mdgriffith$elm_ui$Element$mouseDown(
													_List_fromArray(
														[
															$mdgriffith$elm_ui$Element$Background$color(
															A3($mdgriffith$elm_ui$Element$rgb255, 51, 204, 204)),
															$mdgriffith$elm_ui$Element$Border$color(
															A3($mdgriffith$elm_ui$Element$rgb255, 51, 204, 204)),
															$mdgriffith$elm_ui$Element$Font$color(
											...
											{
												label: $mdgriffith$elm_ui$Element$text('Add item'),
												onPress: $elm$core$Maybe$Just($author$project$RashanList$Additem)
											})
										]))
								]))
						])),
					...
					$author$project$RashanList$renderToList(
						A2(
...
var $author$project$RashanList$main = $elm$browser$Browser$sandbox(
	{init: $author$project$RashanList$init, update: $author$project$RashanList$update, view: $author$project$RashanList$view});
_Platform_export({'RashanList':{'init':$author$project$RashanList$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"RashanList.Msg","aliases":{"RashanList.Item":{"args":[],"type":"{ label : String.String, isPurchased : Basics.Bool, id : Basics.Int }"}},"unions":{"RashanList.Msg":{"args":[],"tags":{"Additem":[],"UpdateNewItem":["String.String"],"ItemPurchased":["RashanList.Item"],"ItemUnPurchased":["RashanList.Item"]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});
